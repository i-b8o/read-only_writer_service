...
func (s *paragraphService) UpdateOne(ctx context.Context, content string, paragraphID, chapterID uint64) error {
	return s.storage.UpdateOne(ctx, content, paragraphID, chapterID)
}
